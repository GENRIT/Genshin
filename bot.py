...
После ответа на вопрос пользователя, сгенерируйте три дополнительных вопроса по этой же теме. Каждый дополнительный вопрос должен начинаться с символа "▷" и быть заключен в тройные обратные кавычки (```).
"""
